    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/hospitalizations/**", "/api/v1/hospitalization-orders/**", "/api/v1/hospitalization-origins/**", "/api/v1/beds/**").hasAuthority("HOSPITALIZATION_READ")
                        .requestMatchers(HttpMethod.POST, "/api/v1/hospitalizations/**", "/api/v1/hospitalization-orders/**").hasAuthority("HOSPITALIZATION_WRITE")
